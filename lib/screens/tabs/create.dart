...
class _CreateTabState extends ConsumerState<CreateTab> {
  ...
  void initState() {
    super.initState();
    // Navigate to step 2 (index 1) after the widget is built
    WidgetsBinding.instance.addPostFrameCallback((_) {
      // Access the provider state to get the page controller
      final providerState = ref.read(characterCreationProvider);
      // Update the index through the notifier
      ref.read(characterCreationProvider.notifier).updateIndex(2);
      // Use the page controller from the state
      providerState.pageController.jumpToPage(2);
    });
  }
